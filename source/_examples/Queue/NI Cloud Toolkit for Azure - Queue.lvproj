...
<Project Type="Project" LVVersion="15008000">
	...
	<Property Name="NI.Project.Description" Type="Str">Contains examples illustrating the use of the Queue VIs in the NI Cloud Toolkit for Azure.</Property>
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Create New Azure Queue.vi" Type="VI" URL="../Create New Azure Queue.vi"/>
		<Item Name="List Azure Queues.vi" Type="VI" URL="../List Azure Queues.vi"/>
		<Item Name="Receive Messages from Azure Queue.vi" Type="VI" URL="../Receive Messages from Azure Queue.vi"/>
		<Item Name="Send Message to Azure Queue.vi" Type="VI" URL="../Send Message to Azure Queue.vi"/>
